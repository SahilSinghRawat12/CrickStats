...
const TeamContent = () => {
 ...
 return (
  <div className='w-full px-4 sm:px-6 md:pl-16'>
    ...
    {/* HEADER */}
    <div className='flex flex-col sm:flex-row items-start sm:items-center w-full md:w-[80%] mt-24 md:mt-10 lg:mt-10 justify-between gap-3'>
    ...
    {/* TEAM LIST */}
    <div className='mt-8 md:mt-12 flex flex-col w-full md:w-[80%] gap-y-4'>

      {
        state.teams.length === 0 ? (

          // 🔥 EMPTY STATE
          <div className="col-span-3 flex flex-col items-center justify-center py-16 gap-4 text-gray-500 text-center">

            <h2 className="text-lg md:text-xl font-semibold">No Teams Created</h2>
        ...
        (state.teams.map( (team)=> {
          ...
          return(
            ...
            <div 
              key={team.id} 
              className='flex flex-col sm:flex-row justify-between gap-3 sm:gap-0 cursor-pointer bg-white border border-b-gray-300 shadow-sm rounded-md items-start sm:items-center px-4 py-3'
            >
              ...
              <div className='flex flex-col sm:flex-row gap-3 sm:gap-5 w-full'>
                ...
                <div className='flex gap-3 sm:gap-5 items-center w-full'>
                  ...
                  <label className="relative w-14 h-14 sm:w-20 sm:h-20 rounded-full overflow-hidden cursor-pointer group flex-shrink-0">
                  ...
                  <div className='flex flex-col w-full lg:w-60'>
                    <h2 
                      className='text-sm md:text-md font-semibold capitalize cursor-pointer hover:underline'
                ...
                <button
                  ...
                  className="bg-red-500 text-white px-3 py-1 h-8 rounded mt-2 sm:mt-0 sm:ml-6 sm:mr-10 mr-0  w-fit"
                >
                  Delete
                </button>
    ...
    {selectedTeam && (
      <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 px-4">
        ...
        <div className="bg-white p-4 sm:p-5 rounded-xl relative max-w-sm w-full">
